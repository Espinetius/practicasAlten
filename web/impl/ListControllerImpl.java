...
import es.alten.fisicaoquimica.utils.PageWrapper;
import es.alten.fisicaoquimica.web.ListController;
...
public abstract class ListControllerImpl<
   ...
   * (non-Javadoc)
   *
   * @see es.alten.fisicaoquimica.example.web.ListController#backEdit(es.alten.fisicaoquimica.example.dto.
   ...
   * (non-Javadoc)
   *
   * @see es.alten.fisicaoquimica.example.web.ListController#list(es.alten.fisicaoquimica.example.dto.
   ...
   * (non-Javadoc)
   *
   * @see es.alten.fisicaoquimica.example.web.ListController#search(es.alten.fisicaoquimica.example.dto.
   * BaseFilterDTO, org.springframework.data.domain.Pageable,
   * org.springframework.ui.Model, java.lang.String,
   * javax.servlet.http.HttpSession)
   */
