...
public class CapitulosControllerImpl extends RestControllerImpl<Capitulos, CapitulosDTO, Long, CapitulosBO> implements CapitulosController {
	...
	@GetMapping("/capitulo/{numCapitulo}")
	public List<CapitulosDTO> findByNumCapitulo(@PathVariable ("capitulo") @NotNull Long capitulo) {
		return bo.findByNumCapitulo(capitulo);
	}

	@GetMapping("/temporadaycapitulo/{temporada}/{capitulo}")
